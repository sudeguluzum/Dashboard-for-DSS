...
<script type="text/javascript" src="https://www.gstatic.com/charts/loader.js"></script>
     ...
     google.charts.load('current', {packages: ['corechart', 'bar']});
      ...
      function drawBasic() {
        ...
        ['İl adı', 'Ön Sipariş Sayısı'],
          <?php 
           $sql="SELECT il_ad, on_siparis from iller,bolge_il where iller.plaka=bolge_il.plaka and bolge_il.bolge_no=9 order by iller.il_ad asc";
        ...
        var options = {
        title: '9. Bölgedeki İllerin Ön Sipariş Sayısı',
        chartArea: {width: '50%'},
        hAxis: {
    ...
    <script type="text/javascript">
      ...
      function drawVisualization() {
        ...
        var options = {
          title : '9.Bölgedeki Yıllık Ortalama Günlük Yoldan Geçen Otomobil Sayısı',
...
<div class="konum"> <a href="bolge9resim.html" target="_blank" rel="noopener noreferrer"><img src="bolgeler/b9.jpg" width="600px"; height="450px"; cursor:zoom-in;/></a></div>
<div id="siparis" class="siparis" style="width:300px; height:90px;padding-top:7px; text-align:center;"> <h5>9.Bölgedeki Ön Sipariş Toplamı </h5> <br>
  <?php 
  $sql="SELECT sum(iller.on_siparis) from iller,bolge_il where iller.plaka=bolge_il.plaka and bolge_il.bolge_no=9";
  $fire=mysqli_query($con,$sql);
  while($result = mysqli_fetch_assoc($fire)) {
